...
<section class="package" id="package">
    <div class="image-container">
        <img src="{{asset('blog/files/india.jpg')}}" class="img1">
        <div class="overlay">India Mountains</div>
    </div>
    ...
    {{-- <div class="package-content">
        ...
        <div class="box">
            <div class="image">
                <a href="{{route('client.mountain.kangchenjunga')}}"><img src="{{asset('blog/files/kangchenjunga.jpeg')}}" alt="">
                <h3>Kangchenjunga</h3>
            </div>
            <div class="stars">
                <a href="#"><i class='bx bxs-star'></i></a>
        ...
        <div class="box">
            <div class="image">
                <a href="{{route('client.mountain.doddabetta')}}"><img src="{{asset('blog/files/doddabetta.jpg')}}" alt="">
                <h3>Doddabetta</h3>
            </div>
